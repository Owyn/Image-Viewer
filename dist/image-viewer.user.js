...
;(function () {
    ...
    async showInViewer(link) {
      ...
      try {
        ...
        if (extractor.viewMode === 'origin-download') {
          ...
          /*away image.preload( // await keyword blocks the execution of the code and awaits for the promise's result
            imageURL,
  ...
  const events = {
    openViewerLinkClick(event) {
      ...
      state.linksSet = $$(SELECTORS.imageLink, document.documentElement)
